...
public class KnifeHeroController : HeroController
{
    ...
    public override void OnInit(int level)
    {
        ...
        {
            PlayerKnifeHeroConfigSO playerKnifeHeroConfig = Resources.Load<PlayerKnifeHeroConfigSO>("HeroConfig/KnifeHeroConfig/Player/" + heroName);
            PlayerKnifeHeroData playerHeroData = playerKnifeHeroConfig.GetHeroData(level);
        ...
        {
            EnemyKnifeHeroConfigSO enemyKnifeHeroConfig = Resources.Load<EnemyKnifeHeroConfigSO>("HeroConfig/KnifeHeroConfig/Enemy/" + heroName);
            EnemyKnifeHeroData enemyHeroData = enemyKnifeHeroConfig.GetHeroData(level);
