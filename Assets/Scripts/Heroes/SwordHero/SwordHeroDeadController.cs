...
public class SwordHeroDeadController : HeroDeadController
{
    ...
    public override void EnterDeadState()
    {
        ...
        ViewManager.Instance.IngameView.OnEnemyHeroDead(transform.position, swordHeroController.CoinReward);
    }
