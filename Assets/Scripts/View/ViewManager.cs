...
public class ViewManager : MonoBehaviour
{
    ...
    [SerializeField] private HerosView herosViewPrefab = null;
    ...
    public HerosView HerosView { private set; get; }
    ...
    private void Awake()
    {
        ...
        else 
        {
            ...
            if (transform.childCount == 0)
            {
                ...
                HerosView = Instantiate(herosViewPrefab, transform, false);
                HerosView.transform.localScale = Vector3.one;
                HerosView.OnHide();
    ...
    public void SetActiveView(ViewType viewType)
    {
        ...
        switch(viewType)
        {
            ...
            case ViewType.EndgameView:
                ...
                break;
            case ViewType.HerosView:
                HerosView.gameObject.SetActive(true);
                HerosView.OnShow();
                currentView = HerosView;
                break;
    ...
    /// <summary>
    /// Load the loading scene with given target scene.
    /// </summary>
    /// <param name="targetScene"></param>
    public void LoadScene(string targetScene)
    {
        LoadingManager.SetTargetScene(targetScene);
